  <div class="mb-4">
      <ul class="flex flex-wrap ml-4 -mb-px text-md font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
          ...
          <form action="" method="get">
              <input type="search" name="search" placeholder="Enter Tage" class="inline-block py-2 mt-2 text-gray-600 border-gray-600 px-4 border rounded ">
              ...
              <table class="w-full">
                  ...
                  <?php
                    ...
                    if (isset($_GET['go']) && !empty($_GET['search'])) {
                        $search = $_GET['search'];
                        $callingQuiz = $connect->query("SELECT * FROM quiz WHERE tag LIKE '%$search%'");
                    } else {
                      ...
                      <tbody>
                          <tr>
                              ...
                              <td class="border py-2 px-4 text-center">
                                  <a href="starttest.php?quizName=<?= $quiz['title']; ?>" class="bg-red-500 text-white font-semibold py-1 px-4 rounded">Start</a>
                              </td>
                          </tr>
                      </tbody>
                  <?php endwhile; ?>
